...
/**
 * Event fired when a todo list item is checked/unchecked.
 *
 * @package     bookingextension_todolist
 * @copyright   2026 Wunderbyte GmbH <info@wunderbyte.at>
 * @license     http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class todolist_item_checked extends base {
    /**
     * Init event metadata.
     *
     * @return void
    ...
    public static function get_name(): string {
        return get_string('event:todolist_item_checked', 'bookingextension_todolist');
    }
